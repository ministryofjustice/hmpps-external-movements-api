...
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.service.TapLocationManager

@Tag(name = UI)
@RestController
@RequestMapping("prisons")
@PreAuthorize("hasRole('${Roles.EXTERNAL_MOVEMENTS_UI}')")
class PrisonController(private val locations: TapLocationManager) {
