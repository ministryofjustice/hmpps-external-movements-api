...
class PrisonController(
  private val overview: GetPrisonOverview,
) {
  ...
  @GetMapping("/{prisonIdentifier}/absence-categorisations")
  fun getPrisonAbsenceCategorisationDomain(
    @PathVariable prisonIdentifier: String,
  ): PrisonAbsenceCategorisations = overview.findCategorisationTypesForPrison(prisonIdentifier)
}
