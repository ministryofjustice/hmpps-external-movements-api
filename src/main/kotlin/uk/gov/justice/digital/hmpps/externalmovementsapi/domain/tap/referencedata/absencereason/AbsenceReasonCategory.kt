...
interface AbsenceReasonCategoryRepository :
  JpaRepository<AbsenceReasonCategory, UUID>,
  FindByCode<AbsenceReasonCategory> {
  override fun findByCode(code: String): AbsenceReasonCategory?
}
