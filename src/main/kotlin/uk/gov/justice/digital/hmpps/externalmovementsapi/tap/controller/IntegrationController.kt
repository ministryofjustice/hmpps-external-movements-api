...
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationResponse
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationResponses
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationUrlBuilder.authorisationOccurrencesUrl
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationUrlBuilder.authorisationUrl
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationUrlBuilder.occurrenceMovementsUrl
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.model.integration.IntegrationUrlBuilder.occurrenceUrl
import uk.gov.justice.digital.hmpps.externalmovementsapi.tap.service.IntegrationRetriever
