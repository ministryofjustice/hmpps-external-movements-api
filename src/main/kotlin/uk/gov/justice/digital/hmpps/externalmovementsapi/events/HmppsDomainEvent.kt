...
interface HmppsDomainEventRepository : JpaRepository<HmppsDomainEvent, UUID> {
  @QueryHints(value = [QueryHint(name = HibernateHints.HINT_NATIVE_LOCK_MODE, value = "LOCK_MODE_UPGRADE_SKIPLOCKED")])
  fun findFirst10ByPublishedIsFalse(): List<HmppsDomainEvent>
}
