...
class WebClientConfiguration(
  ...
  @Bean
  fun nomisMigrationWebClient(authorizedClientManager: OAuth2AuthorizedClientManager, builder: Builder) = authorisedWebClient(builder, authorizedClientManager, nomisMigrationBaseUri, ofSeconds(20))
